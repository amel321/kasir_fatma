                            ...
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <table border="1px solid" style="width:200px;">
                                        <td> Rp.<?php echo number_format($row['TotalHarga'], 0, ',', '.'); ?> <input type="text" style="border:none ;  bacgkround-color:white; color:white;" name="TotalHarga" value="<?php echo $sum ?>" hidden></td>
                                    </table>
                                    <input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
                                    <input type="text" name="PenjualanID" value="<?php echo $d['PenjualanID']; ?>" hidden>
