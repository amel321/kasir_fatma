    ...
    <div class="card mt-3">
        <div class="text-center card bg-danger-subtle text-black">
            <div class="card-header">
                SELAMAT DATANG DIHALAMAN PETUGAS
            </div>
            <div class="container">
                <div class=" mt-5">
                    <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                <div class="card  bg-danger-subtle text-black">
                                    <div class="card-body">
                                        ...
                                        <a href="data_barang.php" class="btn btn-outline-danger btn-sm">Detail</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="card  bg-danger-subtle text-black">
                                    <div class="card-body">
                                        ...
                                        <a href="pembelian.php" class="btn btn-outline-danger btn-sm">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
