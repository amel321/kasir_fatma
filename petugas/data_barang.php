...
<div class="container">
    <div class=" mt-5">
        <div class="card-body">
            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#tambah-data">
                Tambah Data
            </button>
            <a href="printbrg.php" target="printbrg.php" type="button" class="btn btn-primary btn-sm">
                Print Data
            </a>
        </div>
        <div class="card-body">
