...
<div class="container">
    <div class="card mt-2">
        <div class="card-body">
            <a href="cetakpenjualan.php" target="printbrg.php" type="button" class="btn btn-primary btn-sm">
                Print Penjualan
            </a>
        </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <input type="text" name="PelangganID"
                                                value="<?php echo $d['PelangganID']; ?>" class="form-control" hidden>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="NomorTelepon"
                                                value="<?php echo $d['NomorTelepon']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                ...
                <form action="proses_pembelian.php" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="PelangganID" value="<?php echo date("dmHis") ?>"
