        ...
        <div class="body">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>RP. <?php echo number_format($d_detailpenjualan['Subtotal'], 0, ',', '.') ?></td>
                        <td>
                            <div class="my-2">
            ...
            <form method="post" action="simpan_total_harga.php">
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <div class="form-group">
                            <table border="1px solid" style="width:100px;">
                                <td> Rp.<?php echo number_format($row['TotalHarga'], 0, ',', '.'); ?> <input type="text"
                                        style="border:none ;  bacgkround-color:white; color:white;" name="TotalHarga"
                                        value="<?php echo $sum ?>" hidden></td>
                            </table>
                            <input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
                            <input type="text" name="PenjualanID" value="<?php echo $d['PenjualanID']; ?>" hidden>
                        </div>
